#!/usr/bin/env python3
"""Generate SimpleNotes Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\SimpleNotes")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "simplenotes"
TEST = APP / "src" / "test" / "java" / "com" / "simplenotes"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "simplenotes"
...
android {
    namespace = "com.simplenotes"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.simplenotes.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.simplenotes.data.** { *; }
-keep class com.simplenotes.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "simplenotes-game",
    "storage_bucket": "simplenotes-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.simplenotes.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating SimpleNotes project files...")
